...
/**
 * Enriches unnamed pedestrian edges (sidewalks, footways, paths) with the name of the
 * nearest parallel road edge. For each unnamed pedestrian edge, finds the best matching
 * named road using spatial proximity (R-tree) refined by polyline distance and direction.
 *
